package com.lmg.base.controller.interceptor;
...
import com.lmg.base.controller.response.Response;
import com.lmg.base.controller.response.ResponseError;
import com.lmg.base.exception.BaseErrorCodes;
import com.lmg.base.exception.BusinessException;
import com.lmg.base.exception.TechnicalException;
...
public class ResponseExceptionInterceptor {
    ...
    public ResponseEntity<Object> handleException(BusinessException e) {
        ...
        List<String> wordList = Arrays.asList(e.getErrorParams()); 
        Response<Object> response = Response.builder()
            .status(HttpStatus.INTERNAL_SERVER_ERROR.value())
            .error(e.getErrorCode())
            .message(getMessage(e.getErrorCode(),wordList))
            .build();
   ...
   public ResponseEntity<Object> handleException(TechnicalException e) {
        ...
        Response<Object> response = Response.builder()
            .status(HttpStatus.INTERNAL_SERVER_ERROR.value())
            .error(e.getErrorCode())
            .message(getMessage(e.getErrorCode(),null))
            .build();    
    ...
    public ResponseEntity<Object> handleException(Exception e) {
        ...
        Response<Object> response = Response.builder()
            ...
            .message(getMessage(BaseErrorCodes.GENERAL_EXCEPTION.name(),null))
            .build();    
    ...
    public ResponseEntity<Object> handleValidationException(MissingServletRequestParameterException e) {
        ...
        ResponseError responseError = ResponseError.builder()
            ...
            .message(getMessage(BaseErrorCodes.MISSING_MANDATORY_FIELDS.name(),null))
            .build();
   ...
   public ResponseEntity<Object> handleValidationException(MethodArgumentNotValidException e) {
    ...
    private String getMessage(String code,List<String> errorParams) {
        String message;
        
        try {
            message = messageSource.getMessage(code, null, Locale.ENGLISH);
            if(ObjectUtils.isNotEmpty(errorParams))
            {
